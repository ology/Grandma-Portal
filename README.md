...
8. Add your `perl` with `run-portal.pl` as argument, to your grandma's scheduled startup tasks.
...
This path is assumed to be under `Program Files`. So for good ol' [Win7 Solitaire](https://win7games.com/) installed at,
